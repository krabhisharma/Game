var words=["GOOGLE","MICROSOFT","ADOBE","TWITTER","DEVELOPE","AMAZON","SAMSUNG",
...
var letters=[ 'B','D','E','V','E','L','O','P','E','R','H','X',
...
var list={
  ...
  DEVELOPE : [ids[1].id,ids[2].id,ids[3].id,ids[4].id,ids[5].id,ids[6].id,ids[7].id,ids[8].id],
